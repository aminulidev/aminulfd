                ...
                <div className="row g-5">
                    ...
                    <div className="col-md-7 d-grid align-items-center">
                        <div className="about_content">
                            <div className="row g-4 row-cols-2 justify-content-center about_cards">
                                {
                                    aboutData.map((data) => {
                                        return <AboutItem key={data.id} hashLink={data.hashLink} icon={data.icon} title={data.title} description={data.description} />
                                    })
                                }
                            </div>
                        </div>
